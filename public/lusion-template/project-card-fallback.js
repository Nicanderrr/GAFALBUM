(function () {
  ...
  const buildProjectExperience = async (data, card) => {
    ...
    backButton.className = "project-experience__back";
    ...
    backButton.addEventListener("click", (event) => {
      ...
      document.title = "GAFALBUM";
    });
    stage.appendChild(backButton);
  ...
  window.addEventListener("popstate", () => {
    if (!location.pathname.replace(/^\/|\/$/g, "").startsWith("projects/")) closeProjectExperience();
  });
